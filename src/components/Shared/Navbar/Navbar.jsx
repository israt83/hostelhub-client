      ...
      <div className="py-4 border-b-[1px]">
        <Container>
          <div className="flex flex-row items-center justify-between gap-3 md:gap-0">
            ...
            <div className="hidden sm:flex flex-1 justify-center">
              <div className="group mx-2 sm:mx-4">
                <Link
                  to="/"
              ...
              <div className="group mx-2 sm:mx-4">
                <Link
                  to="/meals"
                  className={`nav-link text-base font-semibold ${
                    location.pathname === "/meals" ? "text-orange-500" : ""
                  }`}
                >
                  Meals
                </Link>
              ...
              <div className="group mx-2 sm:mx-4">
                <Link
                  to="/upcoming-meals"
                  className={`nav-link text-base font-semibold ${
                    location.pathname === "/upcoming-meals" ? "text-orange-500" : ""
                  }`}
                >
                  Upcoming Meals
                </Link>
            ...
            <div className="relative flex items-center gap-3">
              ...
              {/* Menu Icon for small screens */}
              <div className="block sm:hidden cursor-pointer px-10">
                <AiOutlineMenu size={24} onClick={() => setIsMenuOpen(!isMenuOpen)} />
              </div>
              ...
              <div
                onClick={() => setIsOpen(!isOpen)}
                className="hidden p-4 sm:py-1 sm:px-2 lg:flex flex-row items-center gap-2 rounded-full cursor-pointer hover:shadow-md transition "
              >
                <p className="hidden lg:block">{user ? "" : "Join Us"}</p>
                <div className="hidden sm:block">
                  <img
          ...
          {/* Dropdown Menu for Small Screens */}
          {isMenuOpen && (
            <div  className="absolute rounded-xl shadow-md w-[40vw] md:w-[10vw] bg-white overflow-hidden right-0 top- text-lg px-2 pb-5 mr-4">
                  <div className="block sm:hidden mt-4">
              <div className="flex flex-col pl-2 text-lg">
                <Link
                  to="/"
                  className={`py-1 hover:bg-neutral-100 transition font-medium ${
                    location.pathname === "/" ? "text-orange-500" : ""
                  }`}
                >
                  Home
                ...
                {user ? (
                  <>
                    ...
                    <div
                      onClick={logOut}
                      className="py-1 hover:bg-neutral-100 transition font-medium cursor-pointer"
                    >
                      Logout
                    </div>
                  </>
