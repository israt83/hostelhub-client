  ...
  return (
    <>
      <footer
        ...
        className="px-4  bg-slate-900 dark:bg-gray-900 shadow-sm  text-[#d4cccc]"
      >
            ...
            >
              ...
              >
                <div className="flex items-center justify-center rounded-full ">
                  ...
                  <p className="text-2xl text-slate-200 uppercase text-center">
              ...
              <p className="text-sm text-[#d4cccc] mt-2 max-w-screen-md text-center lg:text-start ">
                Enhancing your hostel experience with seamless meal management
                ...
                <div className="flex justify-start space-x-3">
                  ...
                  >
                    <a
                      ...
                      href="#"
                      title="Facebook"
                      className="flex items-center p-1 hover:text-orange-600 duration-300"
                    >
                      <svg
        ...
        <div className="py-10 text-sm text-center text-[#dcd0d0] border-t">
