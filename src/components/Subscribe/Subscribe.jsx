...
export default function Subscribe() {
  return (
    <>
      <section className="bg-orange-800 pb-10">
        <section className="py-12 bg-orange-500 px-2 md:px-4 flex flex-col lg:flex-row  items-start lg:items-center   gap-8 lg:gap-0  lg:justify-evenly ">
