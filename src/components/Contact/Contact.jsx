...
const Contact = () => {
    return (
        <section className="bg-white dark:bg-gray-900 mt-4 max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4">
    <div className="container px-6 py-12 mx-auto">
        <div className="text-center">
            <p className="font-medium text-orange-600 dark:text-blue-400">Contact us</p>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-orange-600 dark:text-blue-400">hostelhub@gmail.com</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-orange-600 dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-orange-600 dark:text-blue-400">+1 (555) 000-0000</p>
            </div>
        </div>
    </div>
</section>
